...
import Choreography.WorkerManager.MainThread as WM
...
newtype MainConfig = MainConfig Config

instance Backend MainConfig where
  runNetwork (MainConfig config) _ network = runNetworkMain config network
